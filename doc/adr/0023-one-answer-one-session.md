...
- **The one judgement no pass has witnessed becomes obtainable.** Every written answer tested so far was typed by a machine in the human's voice. Whether a *person* finds the clarifying question reasonable and the escalation timed right is what this phase's gate is for, and six live `ivtrends` questions make it free.
