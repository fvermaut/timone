...
> **Status:** Approved for execution by fvermaut 2026-07-28 — hand-authored the same day (Timone's own phases are planned by hand; `timone-plan` operates on managed projects only).
