...
> **Status:** Built, and gated in part — see [reports/phase-26-live-gate.md](reports/phase-26-live-gate.md). **Four of 26f's seven steps are observed**, one defect was found and fixed mid-gate, and the two that need a person at a keyboard are fvermaut's. Approved for execution by fvermaut on 2026-08-19, as written and without amendment.
