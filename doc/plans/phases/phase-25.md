...
> **Status:** Built to 25g — see [reports/phase-25-complete.md](reports/phase-25-complete.md). **25h, the live gate, is not run.** Approved for execution by fvermaut on 2026-08-18, as written and without amendment.
