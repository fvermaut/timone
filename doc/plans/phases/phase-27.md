...
> **Status:** **Complete 2026-08-19.** All six sub-phases built; 1134 tests pass, 13 of them new. Live-gated on `scratch-app` #4 — see [reports/phase-27-live-gate.md](reports/phase-27-live-gate.md). Every predicted step observed and none of the four falsifiers fired; the approval and the planning session that follows it are fvermaut's to give and are not observed. Written 2026-08-19 after [manual/how-the-daemon-works.md](../../../manual/how-the-daemon-works.md) drew the daemon's states in one place and five gaps became visible. Commissioned by fvermaut on 2026-08-19: *"don't file the bugs, fix them all"*.
